...
#I @"C:\Users\Андрій\.dnx\packages\FunScript\1.1.94\lib\net40"
#I @"C:\Users\Андрій\.dnx\packages\FunScript.TypeScript.Binding.lib\1.1.0.37\lib\net40"
#I @"C:\Users\Андрій\.dnx\packages\FunScript.TypeScript.Binding.angular\1.1.0.37\lib\net40\"
#r "FunScript.dll"
             ...
             [| "$scope" :> obj
                ...
                scope?calculation <- fun () -> //try
                    Math.Round(180. * 1.5 * scope?selected?scopeuse?Coefficient * scope?selected?city?Coefficient
                               * scope?selected?scopeuse?Coefficient).ToString()) //with | _  -> "Enter valid data"
                                                                                  //                   scope?selected <-{
